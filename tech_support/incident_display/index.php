...
if ($action === NULL) {
    ...
    if ($action === NULL) {
        $action = 'incident_select_unassigned';
    }
}
//main action slection
if ($action == 'incident_select_unassigned') {
    $incidents = get_incidents_unassigned();
    include('incident_select_unassigned.php');
}else if ($action == 'incident_select_assigned') {
    $incidents = get_incidents_assigned();
    include('incident_select_assigned.php');
